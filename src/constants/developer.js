const developer = {
	...
	summary: {
		...
		2: 'Passionate about software engineering and committed to continuous learning and the adoption of emerging technologies.',
		3: "I enjoy development because of the satisfaction I get from overcoming challenges. I am motivated by the opportunity to positively impact individuals' lives through software.",
	},
	experience: {
		1: {
			description:
				'During my tenure as a Frontend Developer at EPAM Anywhere, I honed my skills in building responsive web applications while working remotely from Buenos Aires, Argentina.',
			list: [
				'I transformed Figma designs into fully functional web pages using HTML, CSS, JavaScript, and React.',
				'I focused on refactoring code to remove repeated functionalities, creating reusable helper functions that significantly improved the scalability and testability of our projects.',
		...
		2: {
			description:
				'Before EPAM Anywhere, I worked as a Frontend Developer at Fizzit in Copenhagen, Denmark. In this role, I designed user interfaces with Photoshop and developed a responsive web app using HTML, CSS, JavaScript, React, and Material UI.',
			list: [
