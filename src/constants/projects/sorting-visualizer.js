...
const sortingVisualizer = {
	...
	features: [
		'Algorithm Visualization: Experience the sorting process step-by-step with animated representations, allowing users to see how each algorithm operates.',
		'Adjustable Parameters: Users can modify the sorting speed and chart size, tailoring the experience to their preferences and learning pace.',
