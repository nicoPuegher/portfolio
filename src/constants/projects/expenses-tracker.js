...
const expensesTracker = {
	...
	features: [
		'Dynamic Categorization: Users can easily assign expenses to a variety of predefined categories.',
		'Interactive Visualizations: The application features dynamic charts that visually represent monthly expenditures, enabling users to quickly identify spending patterns and trends.',
		'Flexible Filtering: Expenses can be filtered by year or month and are displayed in descending order, allowing users to effortlessly navigate their financial history.',
